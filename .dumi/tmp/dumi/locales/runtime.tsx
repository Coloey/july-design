...
import { RawIntlProvider, createIntl, createIntlCache } from 'D:/MyReactComponents/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from 'D:/MyReactComponents/node_modules/dumi/dist/client/theme-api/utils.js'
    ...
    const matched = locales.slice().reverse().find((locale) => (
      'suffix' in locale
        ...
        : history.location.pathname.replace(/([^/])\/$/, '$1')
          .startsWith("/july-design" + locale.base)
    ));
